...
namespace vega
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<PhotosSettings>(Configuration.GetSection("PhotosSettings"));
            ...
            services.AddAuthentication(options =>
                    ...
                    {
                        options.Authority = "https://devlearning.auth0.com/";
                        options.Audience = "https://api.learningauth0.com";
                    });
